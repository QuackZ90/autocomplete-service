...
const commitsServices = new GeneralServices("/commits");

export default commitsServices;

// const commitsServices ={
...
//                 const response = await githubSearchAPI.get('/commits',{params:searchParams});
