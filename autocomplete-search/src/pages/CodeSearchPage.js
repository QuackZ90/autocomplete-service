//  No longer in use. Merged into search page
...
//     console.log(FIELDS_TO_SHOW["code"])
...
//                 <ConditionalTextInput id="user" labelText="User: " arrToMatch={FIELDS_TO_SHOW["code"]} value={user} onChange={handleChange} />
